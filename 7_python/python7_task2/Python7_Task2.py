...
# фильтруем только успешные транзакции с положительными суммами 
filtered_transactions = [int(t.split(":")[1]) for t in raw_transactions if int(t.split(":")[1]) > 0 and t.startswith("SUCCESS")]
