...
print(f"Партия 1 (Аcademy Dinosaur): Сумма: {final_sum}$. Превышение лимита: {is_limit_exceeded}")
...
print(f"Партия 3 (Аgent Truman): Сумма: {final_sum}$. Превышение лимита: {is_limit_exceeded}")
final_sum, is_limit_exceeded = calculate_rental_batch (
    quantity=50, 
    rental_rate=3.5, 
    discount=0.2)
